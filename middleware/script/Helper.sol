...
contract Helper {
  ...
  address constant linkBSCTestnet = 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06;
  ...
  address constant wethBSCTestnet = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //wbnb;
  ...
  address constant ccipBnMBSCTestnet =
  ...
  address constant ccipLnMBSCTestnet =
    0x79a4Fc27f69323660f5Bfc12dEe21c3cC14f5901;
  address constant ccipLnMBaseGoerli =
    0x73ed16c1a61b098fd6924CCE5cC6a9A30348D944;

  address constant messageSenderOptimismGoerli =
    0xCcB0F7F1DCdcD69d9D48094E3114cb3155F67eb8;
  address constant messageSenderAvalanche =
    0x78966DeFeC946e78BF9E2A7f93b5f443ADbD36eE;
  address constant messageSenderArbitrumTestnet =
    0xCcB0F7F1DCdcD69d9D48094E3114cb3155F67eb8;
  address constant messageSenderPolygonMumbai =
    0xCcB0F7F1DCdcD69d9D48094E3114cb3155F67eb8;
  address constant messageSenderBSCTestnet =
    0xCB20b0Ea108e53777dcc52F1C79aaF268eEeA9Af;
  ...
  function getDummyTokensFromNetwork(
    ...
    if (network == SupportedNetworks.ETHEREUM_SEPOLIA) {
      ...
      return (ccipBnMBSCTestnet, ccipLnMBSCTestnet);
    } else if (network == SupportedNetworks.BASE_GOERLI) {
      return (ccipBnMBaseGoerli, ccipLnMBaseGoerli);
    }
  }
